...
--无障碍版专用脚本
--天气脚本
--用途：根据候选内容在悬浮窗口显示天气信息(执行功能键),支持大部分城市的天气信息,具体请自测
--版本号: 1.0
--制作日期
▂▂▂▂▂▂▂▂
日期: 2020年04月04日🗓️
...
--配置说明
第①步 将 天气.lua 文件放置 rime/script 文件夹内
...
preset_keys:
  lua_tq: {label: 天气, send: function, command: "天气.lua", option: "%1$s"}#选中的候选»天气信息
...
--二次开发说明
--使用方法
require "script.包.其它.天气"
天气信息(城市名称)


--测试方法
preset_keys:
  lua_tq: {label: 天气, send: function, command: "包/其它/天气.lua", option: "%1$s"}#选中的候选»天气信息
]]
...
local 候选 = Rime.getComposingText()  --当前候选
天气信息(候选)
